      ...
      <div className="friendsListSection bg-white/10 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/20 flex flex-col flex-1 overflow-hidden">
        ...
        <div className="friendsList overflow-y-auto custom-scrollbar flex-1">
          {friends.map((friend) => (
            <div
              key={friend.id}
              className="friendItem flex items-center gap-3 p-2 rounded-lg hover:bg-white/10 transition-all mb-2"
            >
              <div
              ...
              <button
                ...
                className="challengeBtn bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white text-xs font-bold px-3 py-1 rounded-full transition-all"
              >
                Challenge
              </button>
            </div>
