...
const ProfileSection = ({ userData }) => {
  return (
    <div className="profileSection bg-white/10 backdrop-blur-md rounded-xl md:rounded-2xl p-3 md:p-4 shadow-xl border border-white/20">
      <div className="profileHeader flex items-center gap-3 md:gap-4">
        <div className="profileImageContainer relative">
          <img
            src={userData.profileImage}
            alt={userData.name}
            className="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-4 border-yellow-400 shadow-lg object-cover"
          />
        ...
        <div className="profileInfo flex-1 min-w-0">
      ...
      <div className="profileStats grid grid-cols-3 gap-2 mt-3 md:mt-4 pt-3 md:pt-4 border-t border-white/20">
        ...
        <div className="stat text-center">
          <div className="text-blue-400 font-bold text-base sm:text-lg">12</div>
